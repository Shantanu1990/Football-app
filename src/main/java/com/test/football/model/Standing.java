...
public class Standing {
	...
	public String toString() {
		return "Standing [country_name=" + country_name + ", league_id=" + league_id
				+ ", league_name=" + league_name + ", team_id=" + team_id + ", team_name=" + team_name
				+ ", overall_promotion=" + overall_promotion + ", overall_league_position=" + overall_league_position
				...
				+ ", home_promotion=" + home_promotion + ", home_league_payed=" + home_league_payed + ", home_league_W="
				+ home_league_W + ", home_league_D=" + home_league_D + ", home_league_L=" + home_league_L
				+ ", home_league_GF=" + home_league_GF + ", home_league_GA=" + home_league_GA + ", home_league_PTS="
				+ home_league_PTS + ", away_league_position=" + away_league_position + ", away_promotion="
				+ away_promotion + ", away_league_payed=" + away_league_payed + ", away_league_W=" + away_league_W
				+ ", away_league_D=" + away_league_D + ", away_league_L=" + away_league_L + ", away_league_GF="
				+ away_league_GF + ", away_league_GA=" + away_league_GA + ", away_league_PTS=" + away_league_PTS
				+ ", league_round=" + league_round + ", team_badge=" + team_badge + "]";
	}
}